...
// 
// texture 
// g_spritesheet = { .path = "button.png", .is_allocated = 0, .x = 0, .y = 0, .w = 0, .h = 0, .ref = 0 };
...
texture 
g_press_texture = { .path = "press.png", .is_allocated = 0, .x = 0, .y = 0, .w = 0, .h = 0, .ref = 0 };

texture 
g_up_texture = { .path = "up.png", .is_allocated = 0, .x = 0, .y = 0, .w = 0, .h = 0, .ref = 0 };

texture 
g_down_texture = { .path = "down.png", .is_allocated = 0, .x = 0, .y = 0, .w = 0, .h = 0, .ref = 0 };

texture 
g_left_texture = { .path = "left.png", .is_allocated = 0, .x = 0, .y = 0, .w = 0, .h = 0, .ref = 0 };

texture 
g_right_texture = { .path = "right.png", .is_allocated = 0, .x = 0, .y = 0, .w = 0, .h = 0, .ref = 0 };
